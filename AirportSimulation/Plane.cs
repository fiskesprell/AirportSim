...
namespace AirportSimulationCl
{
    public class Plane
    {
        ...
        {
            get => _planePassengerCapacity;
            set => _planePassengerCapacity = value;
        }
        private int _planeCargoCapacity;
        public int PlaneCargoCapacity
        {
            get => _planeCargoCapacity;
            set => _planeCargoCapacity = value;
        }
        private int _planeFuelCapacity;
        public int PlaneFuelCapacity
        {
            get => _planeFuelCapacity;
            set => _planeFuelCapacity = value;
        }
